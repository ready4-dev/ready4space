...
methods::setMethod("area_bound_year", methods::className("ready4_meso_area",".GlobalEnv"), function(x) x@area_bound_year)
#' area_bound_year<-
...
methods::setMethod("area_bound_year<-", methods::className("ready4_meso_area",".GlobalEnv"), function(x, value) {
