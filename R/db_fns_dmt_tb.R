#' ready4space function documentation table
#' 
#' Meta-data on each ready4space function used to create package documentation
#' 
#' A tibble
#' 
#' \describe{
...
#' }
#' @source \url{https://ready4-dev.github.io/ready4space/}
"fns_dmt_tb"
