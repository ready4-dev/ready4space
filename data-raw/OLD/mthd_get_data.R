...
procure.ready4_sp_abbreviations_lup <- function (x, col_chr = "short_name", value_chr) 
{
...
#' @export 
#' @importFrom ready4fun get_from_lup
procure.ready4_sp_data_pack_lup <- function (x, col_chr = "main_feature", value_chr, r_data_dir_chr = NA_character_) 
{
...
#' @description procure.ready4_sp_uid_lup() is a Get Data method that retrieves data from R objects loaded in memory. This method is implemented for the Readyforwhatsnext S3 class for tibble object lookup table of unique feature identifiers used for different spatial objects.. The function is called for its side effects and does not return a value.
...
procure.ready4_sp_uid_lup <- function (x, col_chr = "spatial_unit", value_chr, area_bound_yr) 
{
...
methods::setMethod("get_data", "ready4_sp_uid_lup", procure.ready4_sp_uid_lup)
