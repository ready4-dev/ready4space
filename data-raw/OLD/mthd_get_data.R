...
procure.ready4_sp_abbreviations_lup <- function (x, col_nm_1L_chr = "short_name", value_chr) 
{
    ready4::get_from_lup_obj(data_lookup_tb = x, match_value_xx = value_chr, 
...
#' @export 
#' @importFrom ready4fun get_from_lup
procure.ready4_sp_data_pack_lup <- function (x, col_nm_1L_chr = "main_feature", value_chr, r_data_dir_chr = NA_character_) 
{
    if (!is.na(r_data_dir_chr)) {
        x <- add_path_col(x, r_data_dir_chr = r_data_dir_chr)
    }
    readRDS(ready4::get_from_lup_obj(data_lookup_tb = x, match_value_xx = value_chr, 
...
procure.vicinity_identifiers <- function (x, col_nm_1L_chr = "spatial_unit", value_chr, area_bound_yr) 
{
    ready4::get_from_lup_obj(data_lookup_tb = x %>% dplyr::filter(year == 
        area_bound_yr), match_value_xx = value_chr, match_var_nm_1L_chr = col_nm_1L_chr, 
