...
#' @rdname sp_uid_lup-methods
#' @aliases sp_uid_lup,ready4_lookup-method
methods::setMethod("sp_uid_lup", methods::className("ready4_lookup"), function (x) 
{
    x@sp_uid_lup
})
#' sp_uid_lup<-
...
#' @rdname sp_uid_lup_set-methods
#' @aliases sp_uid_lup<-,ready4_lookup-method
methods::setMethod("sp_uid_lup<-", methods::className("ready4_lookup"), function (x, value) 
{
    x@sp_uid_lup <- value
