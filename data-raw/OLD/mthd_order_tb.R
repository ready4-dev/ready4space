...
#' @rdname order_tb-methods
#' @aliases order_tb,ready4_sp_import_lup-method
methods::setMethod("order_tb", "ready4_sp_import_lup", order_tb.ready4_sp_import_lup)
