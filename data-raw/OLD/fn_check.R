...
#' @param key_var_1L_chr PARAM_DESCRIPTION
#' @return NULL
...
validate_popl_predns_incld <- function (data_name_item, data_lookup_tb, key_var_1L_chr) 
{
    purrr::map_chr(data_name_item, ~ready4::get_from_lup_obj(data_lookup_tb = data_lookup_tb, 
        ...
        evaluate_1L_lgl = FALSE)) %>% stringr::str_detect(key_var_1L_chr) %>% 
