...
# ready.plot::plot_seifa_by_SA2_SA1(profiled_sf = spatial_atts_ls[[2]],
#                                      profiled_unit_name = "Area <10km from Orygen Headspaces",
#                                      resolution_unit_name = "sa2",
#                                      year = "2016")
## 5. SIMULATE EVOLUTION OF ENVIRONMENT OVER TIME
# sp_data_sf <- ready.sim::sim_environment(spatial_atts_ls = spatial_atts_ls,
#                               age0 = 12,
#                               age1 = 18,
#                               at_time = "2016",
#                               to_time = "2031",
...
#                               nbr_steps = 2)
# sp_data_sf <- ready.sim::sim_environment(spatial_atts_ls = st_data(st_envir(sim_data)),
...
# env_sf(st_envir(sim_data)) <- ready.sim::sim_environment(spatial_atts_ls = st_data(st_envir(sim_data)),
#                                                          age0 = age_lower(sim_data),
#                                                          age1 = age_upper(sim_data),
#                                                          at_time = pre_model_date(sim_data),
#                                                          to_time = model_end_date(sim_data),
