...
author_VicinityLocalProcessed <- function(x,#import_data #write_fls_from_sp_imp_and_upd_imp_ls
  ...
  imports_ls <- ingest(x = vicinity_raw_r3,#import_data
                       ...
                       data_type_1L_chr = vicinity_raw_r3$data_type_chr,#
  ...
  if(vicinity_raw_r3$data_type_chr == "Geometry"){ #
    ...
    path_to_seed_sf_1L_chr <- x@processed_fls_dir_1L_chr #NA_character_
  }
  author.vicinity_raw(vicinity_raw_r3,#write_procsd_imp_xx
                      imports_ls = imports_ls,
                      path_1L_chr = path_to_seed_sf_1L_chr,
